...
import com.shopgiayonline.model.mapper.PromotionMapper;
import com.shopgiayonline.model.request.CreatePromotionReq;
import com.shopgiayonline.repository.PromotionRepository;
...
public class PromotionServiceImpl implements PromotionService {
    ...
    public Page<Promotion> adminGetListPromotion(String code, String name, String ispublic, String active, int page) {
        ...
        Page<Promotion> rs = promotionRepository.adminGetListPromotion(code, name, ispublic, active,
    ...
    public Promotion createPromotion(CreatePromotionReq req) {
        ...
        if (req.isPublic() && req.isActive()) {
            ...
            if (alreadyPromotion != null) {
                throw new BadRequestException("Chương trình khuyến mãi công khai \"" + alreadyPromotion.getCouponCode()
