...
public interface ProductRepository extends JpaRepository<Product, String> {
        ...
        public List<ProductInfoDto> searchProductByKeyword(@Param("keyword") String keyword, @Param("limit") int limit,
        ...
        public List<ProductInfoDto> searchProductBySize(List<Integer> brands, List<Integer> categories, long minPrice,
                        long maxPrice, List<Integer> sizes, int limit, int offset);
        ...
        public int countProductBySize(List<Integer> brands, List<Integer> categories, long minPrice, long maxPrice,
                        List<Integer> sizes);

        @Query(nativeQuery = true, name = "searchProductAllSize")
        public List<ProductInfoDto> searchProductAllSize(List<Integer> brands, List<Integer> categories, long minPrice,
        ...
        @Query(nativeQuery = true, value = "SELECT DISTINCT product.*\n" +
                        ...
                        "LIMIT ?7\n" +
                        "OFFSET ?8")
        public List<Product> adminGetListProduct(String id, String name, String category, String brand, String order,
        ...
        public int countAdminGetListProduct(@Param("id") String id, @Param("name") String name,
